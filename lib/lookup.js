...
var enterSeries = function (max, done) {
  ...
  // TODO use https://github.com/SBoudrias/Inquirer.js/blob/master/examples/list.js
...
module.exports = function (program, showName, options, done) {
  async.waterfall([
    ...
    function (showId, next) {
      ...
      var noNeedForUpdate = moment(show.updated).add('1 day').isBefore(moment()) || show.info.status === 'Ended';
      if (!options.ignoreCache && noNeedForUpdate) {
